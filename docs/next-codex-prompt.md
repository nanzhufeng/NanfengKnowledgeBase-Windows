...
4. `.runtime-qa/hidden-knowledge-production-20260727-qa4` 已经通过真实隐藏 Tauri IPC 的新对象写入、强制重启读回、migration 1/2/3、完整性和外键检查；
5. 上述证明代码与隔离合同，不证明正式 D:\南枫知识库 已升级或可见桌面已验收。
