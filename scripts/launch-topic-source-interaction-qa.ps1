...
$targetDirectory = Join-Path $projectDirectory ".runtime-qa\automatic-knowledge-ingestion-v64-app"
...
$logDirectory = Join-Path $projectDirectory ".runtime-qa\automatic-knowledge-ingestion-v64-launcher"
...
try {
    $Host.UI.RawUI.WindowTitle = "Nanfeng Knowledge - Automatic Knowledge Ingestion QA"
    ...
    if ($Prepare) {
        ...
        Write-LaunchLog "Building the isolated automatic knowledge ingestion QA executable without opening the application."
        ...
        Write-Host "[PASS] Isolated automatic knowledge ingestion QA application generated." -ForegroundColor Green
    ...
    if ($Verify) {
        ...
        Write-Host "[PASS] Automatic knowledge ingestion launcher and isolated QA application are available." -ForegroundColor Green
