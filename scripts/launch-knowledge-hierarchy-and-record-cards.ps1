...
$targetDirectory = Join-Path $projectDirectory ".runtime-qa\knowledge-hierarchy-v14-build"
$applicationPath = Join-Path $targetDirectory "release\nanfeng-knowledge-base.exe"
$logDirectory = Join-Path $projectDirectory ".runtime-qa\knowledge-hierarchy-v14-launcher"
...
try {
    $Host.UI.RawUI.WindowTitle = "Nanfeng Knowledge - Hierarchy and Record Cards QA"
