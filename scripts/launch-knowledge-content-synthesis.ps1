...
$targetDirectory = Join-Path $projectDirectory ".runtime-qa\knowledge-content-synthesis-v5-build"
$applicationPath = Join-Path $targetDirectory "release\nanfeng-knowledge-base.exe"
$logDirectory = Join-Path $projectDirectory ".runtime-qa\knowledge-content-synthesis-v5-launcher"
...
try {
    $Host.UI.RawUI.WindowTitle = "Nanfeng Knowledge - Content Synthesis QA"
