...
$targetDirectory = Join-Path $projectDirectory ".runtime-qa\dynamic-scene-contrast-v11-build"
$applicationPath = Join-Path $targetDirectory "release\nanfeng-knowledge-base.exe"
$logDirectory = Join-Path $projectDirectory ".runtime-qa\dynamic-scene-contrast-v11-launcher"
...
try {
    $Host.UI.RawUI.WindowTitle = "Nanfeng Knowledge - Dynamic Scene Contrast QA"
