...
$targetDirectory = Join-Path $projectDirectory ".runtime-qa\knowledge-dedup-attachment-layout-v9-build"
$applicationPath = Join-Path $targetDirectory "release\nanfeng-knowledge-base.exe"
$logDirectory = Join-Path $projectDirectory ".runtime-qa\knowledge-dedup-attachment-layout-v9-launcher"
...
try {
    $Host.UI.RawUI.WindowTitle = "Nanfeng Knowledge - Dedup Attachment Layout QA"
