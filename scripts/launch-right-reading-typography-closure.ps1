...
$targetDirectory = Join-Path $projectDirectory ".runtime-qa\right-reading-typography-v12-build"
$applicationPath = Join-Path $targetDirectory "release\nanfeng-knowledge-base.exe"
$logDirectory = Join-Path $projectDirectory ".runtime-qa\right-reading-typography-v12-launcher"
...
try {
    $Host.UI.RawUI.WindowTitle = "Nanfeng Knowledge - Right Reading Typography Closure QA"
